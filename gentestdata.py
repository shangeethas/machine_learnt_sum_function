...
for i in range(number_points):
    # ground truth
    output.append(random_test_integers_a[i] + random_test_integers_b[i] + random_test_integers_c[i])

d = {'a': random_test_integers_a, 'b': random_test_integers_b, 'c': random_test_integers_c, 'y': output}
